$( document ).ready(function() {
    ...
    function reverseEachWorkDay(){
    	prinMonthDayGrid();//Печатаем общую сетку графика
            ...
            $($("#WrapR_rest .row3 .dayGrid").get().reverse()).each(function() {
                scoreR3++;
            ...
            $($("#WrapR_rest .row4 .dayGrid").get().reverse()).each(function() {
                scoreR4++;
            ...
            $($("#WrapR_rest .row5 .dayGrid").get().reverse()).each(function() {
                scoreR5++;
    ...
    $(" #WrapR_rest #backMonth").click(function(e){
    	...
    	if ($('body  #WrapR_rest .collum:nth-child(1) .row3 .dayGrid').hasClass('black') === false	&&	
    		$('body  #WrapR_rest .collum:nth-child(2) .row3 .dayGrid').hasClass('black') === false) {

    		scoreR3 = 2;
   		}

    	if ($('body  #WrapR_rest .collum:nth-child(1) .row3 .dayGrid').hasClass('black') === true	&&	
    		$('body  #WrapR_rest .collum:nth-child(2) .row3 .dayGrid').hasClass('black') === false) {
    	...
    	if ($('body  #WrapR_rest .collum:nth-child(1) .row3 .dayGrid').hasClass('black') === true	&&	
    		$('body  #WrapR_rest .collum:nth-child(2) .row3 .dayGrid').hasClass('black') === true) {
    	...
    	if ($('body #WrapR_rest .collum:nth-child(1) .row4 .dayGrid').hasClass('black') === false	&&	
    		$('body #WrapR_rest .collum:nth-child(2) .row4 .dayGrid').hasClass('black') === false) {

    		scoreR4 = 2;
   		}

    	if ($('body #WrapR_rest .collum:nth-child(1) .row4 .dayGrid').hasClass('black') === true	&&	
    		$('body #WrapR_rest .collum:nth-child(2) .row4 .dayGrid').hasClass('black') === false) {
    	...
    	if ($('body #WrapR_rest .collum:nth-child(1) .row4 .dayGrid').hasClass('black') === true	&&	
    		$('body #WrapR_rest .collum:nth-child(2) .row4 .dayGrid').hasClass('black') === true) {
